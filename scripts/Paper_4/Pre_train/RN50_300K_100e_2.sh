#!/bin/bash
#SBATCH --job-name="RN50_300K_100e_2"
...
srun python tools/run_distributed_engines_300K.py \
  hydra.verbose=true \
  ...
  config.CHECKPOINT.DIR="/scratch/tjian/PythonProject/deep_plastic_Flux_SSL/checkpoint/train_weights/RN50_300K_100e/vissl_100e/" \
  config.HOOKS.TENSORBOARD_SETUP.USE_TENSORBOARD=true \
  config.WEIGHTS_INIT.PARAMS_FILE="/scratch/tjian/PythonProject/deep_plastic_Flux_SSL/checkpoint/train_weights/RN50_300K_100e/vissl_50e/model_final_checkpoint_phase49.torch" \
