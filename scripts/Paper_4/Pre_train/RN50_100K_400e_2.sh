#!/bin/bash
#SBATCH --job-name="RN50_100K_400e_2"
...
srun python tools/run_distributed_engines_100K.py \
  ...
  config.CHECKPOINT.DIR="/scratch/tjian/PythonProject/deep_plastic_Flux_SSL/checkpoint/train_weights/RN50_100K_400e/vissl_200e_to_400e" \
  config.HOOKS.TENSORBOARD_SETUP.USE_TENSORBOARD=true \
  config.WEIGHTS_INIT.PARAMS_FILE="/scratch/tjian/PythonProject/deep_plastic_Flux_SSL/checkpoint/train_weights/RN50_100K_400e/vissl_200e/model_phase200.torch" \
