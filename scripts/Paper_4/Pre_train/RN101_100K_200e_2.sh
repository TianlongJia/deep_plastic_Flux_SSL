#!/bin/bash
#SBATCH --job-name="RN101_100K_200e_2"
...
srun python tools/run_distributed_engines_100K.py \
  ...
  config.CHECKPOINT.DIR="/scratch/tjian/PythonProject/deep_plastic_Flux_SSL/checkpoint/train_weights/RN101_100K_200e/vissl_100_to_200e" \
  config.HOOKS.TENSORBOARD_SETUP.USE_TENSORBOARD=true \
  config.WEIGHTS_INIT.PARAMS_FILE="/scratch/tjian/PythonProject/deep_plastic_Flux_SSL/checkpoint/train_weights/RN101_100K_200e/vissl_100e/model_phase100.torch" \
