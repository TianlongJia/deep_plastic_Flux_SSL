#!/bin/bash
#SBATCH --job-name="RN50_300K_100e_1"
...
srun python tools/run_distributed_engines_300K.py \
  ...
  config.CHECKPOINT.DIR="/scratch/tjian/PythonProject/deep_plastic_Flux_SSL/checkpoint/train_weights/RN50_300K_100e/vissl_50e" \
