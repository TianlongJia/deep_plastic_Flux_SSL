...
srun python tools/object_detection_benchmark_1.py \
    --config-file /scratch/tjian/PythonProject/deep_plastic_Flux_SSL/configs/config/benchmark/object_detection/COCOInstance/R50_C4_COCO/tiles_224/Flux/FRC_50_ANI_TV.yaml \
     --num-gpus 1 SOLVER.MAX_ITER 114050 TEST.EVAL_PERIOD 1141 SOLVER.IMS_PER_BATCH 4 MODEL.BACKBONE.FREEZE_AT 0 MODEL.WEIGHTS /scratch/tjian/PythonProject/deep_plastic_Flux_SSL/checkpoint/train_weights/RN50_500K/detectron2_200e/RN50_500K_200e.torch OUTPUT_DIR /scratch/tjian/PythonProject/deep_plastic_Flux_SSL/checkpoint/train_weights/RN50_500K/Exp2/ANI_TV_F0/
