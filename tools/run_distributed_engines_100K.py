...
train_path="/scratch/tjian/Data/Flux/images_pretrain_100K/train"
val_path="/scratch/tjian/Data/Flux/images_pretrain_100K/val"
...
if __name__ == "__main__":
    ...
    training_time = round((days*24*60*60+seconds)/(60*60))
    print("training_time: ", training_time, " h")
